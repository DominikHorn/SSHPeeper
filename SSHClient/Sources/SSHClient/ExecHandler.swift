/*===----------------------------------------------------------------------===//
 This source file is based on code found in the SwiftNIO open source project,
 i.e., it modifies the original source.
 
 This file, baring custom modifications, is subject to Copyright (c) 2020 Apple Inc.
 and the SwiftNIO project authors Licensed under Apache License v2.0:
